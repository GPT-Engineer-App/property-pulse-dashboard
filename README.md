...
**Project**: property-pulse-dashboard 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a dashboard for maanging real estate investments 
...
```sh
git clone https://github.com/GPT-Engineer-App/property-pulse-dashboard.git
cd property-pulse-dashboard
npm i
